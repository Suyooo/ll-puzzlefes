...
<div class="relative w-full">
    ...
    {/if}
    <label class="vhd" for="input">Your Guess. Autocomplete.</label>
    <input autocapitalize="off" autocomplete="false" bind:this={inputElement} bind:value={input} class="flex-grow text-sm w-full rounded p-2 text-white bg-gray-700 ring-inset ring-2 ring-primary-500
               focus:ring-white"
           id="input" on:autocomplete={setInputValue}
           on:keydown={enterSubmit} placeholder="Which album is this?" type="text" use:autocomplete>

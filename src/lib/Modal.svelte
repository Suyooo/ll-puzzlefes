...
-->
<div class="absolute left-0 top-0 w-full bottom-0 bg-gray-900 bg-opacity-80 flex items-start justify-center px-8 pt-24"
     on:click={closeModal} transition:fade={{duration: 300}} use:focusTrap>
